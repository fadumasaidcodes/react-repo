...
function GameSettings({ testType, difficulty, numOfQuestion, onFormFieldChange, onFormsubmit, onQuizStart, onTimerOption }) {
  ...
  return (
    <div>
      ...
      <div className="hero-body" style={{ height: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center', background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(75, 73, 73, 0.8)), url("../images/word.jpg")', backgroundSize: 'cover', backgroundAttachment: 'fixed', backgroundPosition: '50% 50%', color: 'white !important' }}>
  <h1 style={{ fontSize: 60 }} className="title has-text-weight-bold" >
    Welcome to Lingo!
  </h1>
  <p style={{ fontSize: 30 }} className="subtitle">
