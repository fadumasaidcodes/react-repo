  ...
  return (
   <div style={{display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", height: "100vh"}}>
    <h1 style={{color: "black"}}>
      Welcome to&nbsp;
      <p style={{color: "blue", backgroundColor: "yellow", display: "inline"}}>L</p>
      <p style={{color: "green", backgroundColor: "yellow", display: "inline"}}>I</p>
      <p style={{color: "red", backgroundColor: "yellow", display: "inline"}}>N</p>
      <p style={{color: "yellow", backgroundColor: "yellow", display: "inline"}}>G</p>
      <p style={{color: "white", backgroundColor: "yellow", display: "inline"}}>O:</p>&nbsp;
